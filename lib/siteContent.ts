...
export interface SiteLocaleContent {
  ...
  hero_eyebrow: string; hero_title_a: string; hero_title_b: string; hero_subtitle: string; hero_primary_cta: string; hero_secondary_cta: string; hero_note_one: string; hero_note_two: string
  about_eyebrow: string; about_title: string; about_body: string
  feature_one_title: string; feature_one_body: string; feature_two_title: string; feature_two_body: string; feature_three_title: string; feature_three_body: string; feature_four_title: string; feature_four_body: string
  courses_eyebrow: string; courses_title: string; courses_body: string; course_view: string; course_badge: string
  cta_title: string; cta_body: string
  footer_description: string; footer_reviewed: string; footer_team_name: string; footer_team_role: string; footer_email: string; footer_links_title: string; footer_rights: string; footer_tagline: string
}

export interface SiteBranding { logo_url: string; favicon_url: string; preview_image_url: string }
export interface SiteContent { en: SiteLocaleContent; ar: SiteLocaleContent; branding: SiteBranding }

export const defaultSiteContent: SiteContent = {
  en: {
    meta_title: "PharmaCore — Pharmacy Education", meta_description: "A specialized educational platform for pharmacy and pharmacology courses.",
    hero_eyebrow: "Open pharmacy learning platform", hero_title_a: "Understand pharmacy", hero_title_b: "deeply. Apply it confidently.", hero_subtitle: "Structured learning paths that connect lectures, notes, quizzes, and community questions — open to every student, with no sign-up.", hero_primary_cta: "Explore courses", hero_secondary_cta: "See how learning works", hero_note_one: "No sign-up or subscription", hero_note_two: "Educator-guided structure",
  ...
  ar: {
    meta_title: "فارما كور — منصة التعليم الصيدلي", meta_description: "منصة تعليمية متخصصة في مقررات الصيدلة وعلم الأدوية.",
  ...
  branding: { logo_url: "", favicon_url: "", preview_image_url: "" }
}

export const contentGroups: Array<{ title: string; fields: Array<keyof SiteLocaleContent> }> = [
  { title: "Link preview", fields: ["meta_title", "meta_description"] },
  { title: "Hero", fields: ["hero_eyebrow", "hero_title_a", "hero_title_b", "hero_subtitle", "hero_primary_cta", "hero_secondary_cta", "hero_note_one", "hero_note_two"] },
  { title: "About section", fields: ["about_eyebrow", "about_title", "about_body", "feature_one_title", "feature_one_body", "feature_two_title", "feature_two_body", "feature_three_title", "feature_three_body", "feature_four_title", "feature_four_body"] },
  { title: "Courses and CTA", fields: ["courses_eyebrow", "courses_title", "courses_body", "course_view", "course_badge", "cta_title", "cta_body"] },
  { title: "Footer", fields: ["footer_description", "footer_reviewed", "footer_team_name", "footer_team_role", "footer_email", "footer_links_title", "footer_rights", "footer_tagline"] },
]

export const contentLabel = (field: keyof SiteLocaleContent) => field.replaceAll("_", " ").replace(/^\w/, (letter) => letter.toUpperCase())
...
export const mergeSiteContent = (content?: Partial<SiteContent> | null): SiteContent => ({
  ...
  branding: { ...defaultSiteContent.branding, ...(content?.branding ?? {}) },
})
