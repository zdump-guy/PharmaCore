...
export interface SiteContent { en: SiteLocaleContent; ar: SiteLocaleContent }

// These identity and sharing settings intentionally live in source code rather
// than the admin-managed `site_content` record.
